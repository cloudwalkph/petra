          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="file.png" class="user-image" alt="User Image">
                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                <span class="hidden-xs">Rogh Sawangen</span>
              </a>
              <ul class="dropdown-menu">
                <!-- The user image in the menu -->
                <li class="user-header">
                  <img src="file.png" class="img-circle" alt="User Image">

                  <p>
                    Rogh Sawangen - Web Developer
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="prof.png" class="img-circle" alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href="/project"><i class="fa fa-list-ul"></i><span>Projects</span></a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="/user">Member List</a></li>
